<?php 
    ...
    class AppController extends Action { 
        ...
        //     //variação de paginação
        //     $total_registros_pagina = 5;
        //     $pagina = isset($_GET['pagina']) ? $_GET['pagina'] : 1;
        //     $deslocamento_registros_pagina = ($pagina - 1) * $total_registros_pagina ;

        //     //$tweets = $tweet->getAll();
        //     $tweets = $tweet->getPorPagina($total_registros_pagina, $deslocamento_registros_pagina);
        //     $total_tweets = $tweet->getTotalRegistros();
        //     $total_paginas = ceil($total_tweets['total'] / $total_registros_pagina);
